...
$ModelName = 'App\Reallocation';
$ParentRouteName = 'reallocation';
                            ...
                            <div class="body">
                                <form class="form" id="form_validation" method="post"
                                    ...
                                    <div class="row clearfix">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                            name="showBudgetItem"
                                                            id="showBudgetItems" onchange="showBudget()">
                                                        <option value="0" class="font-custom-bold">Select reallocation type</option>
                                                        <option value="1">Add new budget item</option>
                                                        <option value="2">Add to existing budget item</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="addNewBudgetItem" style="display: none;">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <select data-live-search="true" class="form-control show-tick"
                                        ...
                                        <div id="addToExistingBudgetItem"  style="display: none;">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <select data-live-search="true" class="form-control show-tick" name="cost_item_id">
                                                            <option value="0" class="font-custom-bold">Select to existing budget item</option>
                                                            @if (count($costItems))
                                                                @foreach ($costItems as $costItem)
                                                                    <option value="{{$costItem->id}}" class="font-custom-bold">{{$costItem->title ? $costItem->title : ''}}</option>            
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
...
@push('include-js')
    ...
    <script>
        ...
        @endif
        function showBudget(){
            jQuery("#addNewBudgetItem").hide();
            jQuery("#addToExistingBudgetItem").hide();
