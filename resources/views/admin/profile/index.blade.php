                            ...
                            <div class="image-area">
                                @if ( empty($profile->profile['avatar']) )
                                    <img class="width-140 height-140" src="{{ asset('upload/avatar/avatar.png') }}"
                                         alt="Avatar"/>
                                @else
                                    <img class="width-140 height-140" src="{{ asset($profile->profile['avatar']) }}"
                                         alt="Profile Picture"/>
                                @endif
                        ...
                        <div class="body">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="content">
                                        {{ $profile->profile["present_address"] }}
                                    </div>
                                </li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in active" id="profile_settings">
                                        <form enctype="multipart/form-data" class="form-horizontal" method="post"
                                              action="{{route('profile.update',['id'=>$profile->profile["id"]])}}">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="designation"
                                                               ...
                                                               value="{{ $profile->profile["designation"] }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        <select class="form-control show-tick" name="gender"
                                                            ...
                                                            <option @if ($profile->profile["gender"]==1)
                                                                    selected
                                                                    @endif value="1">Male
                                                            </option>
                                                            <option @if ($profile->profile["gender"]==2)
                                                                    selected
                                                                    @endif value="2">Female
                                                            </option>
                                                            <option @if ($profile->profile["gender"]==3)
                                                                    selected
                                                                    @endif value="3">Common
                                                            </option>
                                                            <option @if ($profile->profile["gender"]==4)
                                                                    selected
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="permanent_address"
                                                               ...
                                                               value="{{ $profile->profile["permanent_address"] }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="present_address"
                                                               ...
                                                               value="{{ $profile->profile["present_address"] }}">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        ...
                                                        <textarea class="form-control" id="description"
                                                                  ...
                                                                  placeholder="description">{{ $profile->profile["description"] }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
