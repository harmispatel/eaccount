...
$ParentRouteNamegeneral = 'settings.general';
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <ul class="nav nav-tabs">
                            <li><a href="{{ route($ParentRouteNamegeneral) }}">General</a></li>
                            <li class="active"><a href="{{ route($ParentRouteName) }}">System</a></li>
                            <li><a data-toggle="tab" href="#menu2">Quater</a></li>
