...
$breadcrumbMainIcon = "fas fa-check-circle";
$breadcrumbCurrentIcon = "archive";

$ModelName = 'App\Approval';
$ParentRouteName = 'approval';


$all = config('role_manage.Approval.All');
$create = config('role_manage.Approval.Create');
$delete = config('role_manage.Approval.Delete');
$edit = config('role_manage.Approval.Edit');
$pdf = config('role_manage.Approval.Pdf');
$permanently_delete = config('role_manage.Approval.PermanentlyDelete');
$restore = config('role_manage.Approval.Restore');
$show = config('role_manage.Approval.Show');
$trash_show = config('role_manage.Approval.TrashShow');
