...
class NotificationsetController extends Controller
{

//    Important properties
    public $parentModel = Notificationset::class;
    public $parentRoute = 'notificationset';
    public $parentView = "admin.notificationset";
    ...
    public function store(Request $request)
    {
        ...
        $emailTemplate = new Notificationset;
    ...
    public function update(Request $request, $id)
    {
        ...
        $emailTemplate = Notificationset::find($id);
        $emailTemplate->type = $request->type;
        $emailTemplate->description = $request->description;
        $emailTemplate->subject = $request->subject;
        $emailTemplate->body = $request->body;
