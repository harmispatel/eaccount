...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'project.module_show' => \App\Http\Middleware\Roles\Project\ModuleShow::class,
        'project.show' => \App\Http\Middleware\Roles\Project\Show::class,
        'project.create' => \App\Http\Middleware\Roles\Project\Create::class,
        'project.edit' => \App\Http\Middleware\Roles\Project\Edit::class,
        'project.delete' => \App\Http\Middleware\Roles\Project\Delete::class,
        'project.pdf' => \App\Http\Middleware\Roles\Project\Pdf::class,
        'project.restore' => \App\Http\Middleware\Roles\Project\Restore::class,
        'project.trash_show' => \App\Http\Middleware\Roles\Project\TrashShow::class,
        'project.permanently_delete' => \App\Http\Middleware\Roles\Project\PermanentlyDelete::class,

        'activity.module_show' => \App\Http\Middleware\Roles\Activity\ModuleShow::class,
        'activity.show' => \App\Http\Middleware\Roles\Activity\Show::class,
        'activity.create' => \App\Http\Middleware\Roles\Activity\Create::class,
        'activity.edit' => \App\Http\Middleware\Roles\Activity\Edit::class,
        'activity.delete' => \App\Http\Middleware\Roles\Activity\Delete::class,
        'activity.pdf' => \App\Http\Middleware\Roles\Activity\Pdf::class,
        'activity.restore' => \App\Http\Middleware\Roles\Activity\Restore::class,
        'activity.trash_show' => \App\Http\Middleware\Roles\Activity\TrashShow::class,
        'activity.permanently_delete' => \App\Http\Middleware\Roles\Activity\PermanentlyDelete::class,

        'cost_item.module_show' => \App\Http\Middleware\Roles\Cost_item\ModuleShow::class,
        'cost_item.show' => \App\Http\Middleware\Roles\Cost_item\Show::class,
        'cost_item.create' => \App\Http\Middleware\Roles\Cost_item\Create::class,
        'cost_item.edit' => \App\Http\Middleware\Roles\Cost_item\Edit::class,
        'cost_item.delete' => \App\Http\Middleware\Roles\Cost_item\Delete::class,
        'cost_item.pdf' => \App\Http\Middleware\Roles\Cost_item\Pdf::class,
        'cost_item.restore' => \App\Http\Middleware\Roles\Cost_item\Restore::class,
        'cost_item.trash_show' => \App\Http\Middleware\Roles\Cost_item\TrashShow::class,
        'cost_item.permanently_delete' => \App\Http\Middleware\Roles\Cost_item\PermanentlyDelete::class,

        'department.module_show' => \App\Http\Middleware\Roles\Department\ModuleShow::class,
        'department.show' => \App\Http\Middleware\Roles\Department\Show::class,
        'department.create' => \App\Http\Middleware\Roles\Department\Create::class,
        'department.edit' => \App\Http\Middleware\Roles\Department\Edit::class,
        'department.delete' => \App\Http\Middleware\Roles\Department\Delete::class,
        'department.pdf' => \App\Http\Middleware\Roles\Department\Pdf::class,
        'department.restore' => \App\Http\Middleware\Roles\Department\Restore::class,
